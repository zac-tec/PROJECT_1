...
*/
const CACHE_NAME = "brickfactory-shell-accounts1";
const SHELL_FILES = [
  "login.html",
  "js/customer-accounts.js?v=accounts1",
  "js/sale-customer-account.js?v=accounts1",
  "js/production-settings.js?v=dates1",
