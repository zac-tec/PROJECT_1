async function loadStockHistory() {
  ...
  try {
    ...
    if(data.manual_days?.length){paragraph('Manually entered historical production and sales');table(['Date','Opening','Mixes','Produced','Sales','Found cured','Damaged','Closing'],data.manual_days.map(r=>[r.date,r.opening,r.mixes,r.production,r.sales,r.found_cured||0,r.damaged||0,r.closing]));}
